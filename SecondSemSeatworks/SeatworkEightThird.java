...
public class SeatworkEightThird {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Enter disvisor: ");
            int divisor = sc.nextInt();

            int result = data[index] / divisor;
            System.out.println("\nResult: " + result);
        } catch (InputMismatchException e) {
            System.out.println("\nError: Invalid input. Please enter whole number only.");
        } catch (ArithmeticException e) {
            System.out.println("\nError: Division by zero is not allowed.");
        } catch (ArrayIndexOutOfBoundsException e) {
            System.out.println("\nError: Index out of bounds. Please enter an index between 0 and 2.");
        } catch (Exception e) {
